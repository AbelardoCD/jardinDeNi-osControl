...
//$id_colegiatura= isset($_POST['id_colegiatura']) ? $_POST['id_colegiatura'] : "0";
...
if ($opcion == "listar_colegiatura"){
    ...
    $consulta = "SELECT id_colegiatura,id_alumno,fecha_pago,fecha_pagado,monto FROM colegiatura "; 
