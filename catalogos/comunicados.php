...
<head>
    ...
    <script type='text/javascript' src='../js/nuestro_mundo/comunicados.js'></script>
    ...
    <div class="container-fluid" id="div_form">
        ...
        <form id="frmDatos" role="form" name="frmDatos" data-toggle="validator">
            ...
            <div class="form-group">
                <label class="col-sm-4 col-form-label">Recados</label>
                <div class="col-sm-8">
                <input type="text" class="form-control" id="txtRecado" name="txtRecado" placeholder="Recado" required data-required-error='Requerido' />
