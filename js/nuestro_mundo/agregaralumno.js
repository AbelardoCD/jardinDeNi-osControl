...
$().ready(function () {
    ...
    function listarRegistros() {
        ...
        $.ajax({
            data: params,
            url: 'operaciones_agregaralumno.php',
            type: 'POST',
            async: true,
            success: function (response) {
                ...
                if (listaRegistros == false) {
                    ...
                    for (var i = 0; i < listaRegistros.length; i++) {
                        ...
                        tr += "<td align=center>";
                        tr += "<a class='btn btn-success' href = '../catalogos/alumnoprimero.php'>Abrir</a>";  
...
/*function editarRegistro(id) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            //dibujar los datos
            $('#txtGrupo').val(datos[1]);
           // $('#comboTutor').val(datos[2]);
