  ...
  $().ready(function () {
   ...
   // listarTipoUsuario();
    ...
    function listarRegistros() {
        ...
        $.ajax({
            data: params,
            url: 'operaciones_comunicados.php',
            type: 'POST',
            async: true,
            success: function (response) {
                ...
                if (listaRegistros == false) {
                    ...
                    for (var i = 0; i < listaRegistros.length; i++) {
                        ...
                        tr += "<td align=center>";
                        tr += "     <label class='btn btn-success' onclick='editarRegistro(" + item.id_comunicado + ")' >Editar</button>";
                        tr += "</td>";
                        tr += "<td align=center>";
                        tr += "     <label class='btn btn-success' onclick='eliminarRegistro(" + item.id_comunicado + ")' >Eliminar</button>";
                        tr += "</td>";
                        tr += "</tr>";
    ...
    if (!hasErrors) {
           var nombre = $('#txtRecado').val().trim();
            ...
            var params = {};
            params.id_comunicado= id_registro_seleccionado;
            params.comunicado = $('#txtRecado').val();
