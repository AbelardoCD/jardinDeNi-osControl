...
$().ready(function () {
            ...
            success: function (response) {
                ...
                if (listaRegistros == false) {
                    ...
                    for (var i = 0; i < listaRegistros.length; i++) {
                        ...
                        var tr = "";    
                        tr += "<tr>";
                        tr += "<td>" + item.id_grupo + "</td>"; 
                        tr += "<td>" + item.nombre_grado + " "+item.nombre_grupo +"</td>";
                        tr += "<td>" + item.profesor_encargado + "</td>"; 
                        ...
                        tr += "<td align=center>";
                        tr += "     <label class='btn btn-success' onclick='editarRegistro(" + item.id_grupo + ")' >Editar</button>";
                        tr += "</td>";
                        tr += "<td align=center>";
                        tr += "     <label class='btn btn-success' onclick='eliminarRegistro(" + item.id_grupo + ")' >Eliminar</button>";
                        tr += "</td>";
                        tr += "<td align=center>";
                        tr += "     <a class='btn btn-success' href ='../catalogos/alumnoprimero.php?idGrupo="+  item.id_grupo + "' >Abrir</a>";
                        tr += "</td>";
                        tr += "</tr>";
    ...
    $('#btnGuardar').click(function () {
        ...
        if (validacionesOk) {
            ...
            params.nombre = $('#txtGrupo').val();
            params.profesor_encargado = $('#txtProfesorCargo').val();
            ...
            success: function (response) {
                ...
                if (listaRegistros == false) {
                    ...
                    for (var i = 0; i < listaRegistros.length; i++) {
                        ...
                        opcion += "<option value = '" + item.id_grupo +  "'>" + item.nombre + "</option>";
                    }
...
function editarRegistro(id) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            //dibujar los datos
            $('#comboGrado').val(datos[1]);
            $('#txtGrupo').val(datos[2]);
            $('#txtProfesorCargo').val(datos[3]);
