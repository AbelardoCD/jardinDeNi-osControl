...
$().ready(function () {
            ...
            success: function (response) {
                ...
                if (listaRegistros == false) {
                    ...
                    for (var i = 0; i < listaRegistros.length; i++) {
                        ...
                        tr += "</td>";
                        tr += "<td align=center>";
                        tr += "     <label class='btn btn-success' onclick='eliminarRegistro(" + item.id_usuario + ")' >Eliminar</button>";
                        tr += "</td>";
                        tr += "</tr>";
    ...
    $('#btnGuardar').click(function (e) {
        ...
        if (!hasErrors) {
            ...
            params.id_tipo_usuario = $('#comboTipoUsuario').val();
